            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{ route('category.all') }}">Liệt kê danh mục sản phẩm</a></li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('brand.add') }}">Thêm danh mục sản phẩm</a></li>
						<li><a href="{{ route('brand.all') }}">Liệt kê danh mục sản phẩm</a></li>
