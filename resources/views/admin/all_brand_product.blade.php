        ...
        <tbody>
            ...
            <td>
              <?php
               if($brand->status==0){
                ?>
                <a href="{{URL::to('/unactive-brand-product/'.$brand->id)}}"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                <?php
                 }else{
                ?>  
                 <a href="{{URL::to('/active-brand-product/'.$brand->id)}}"><span class="fa-thumb-styling fa fa-thumbs-down" style="color: red"></span></a>
                <?php
               }
              ?>
            </td>
